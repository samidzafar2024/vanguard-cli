---
description: "Publish vanguard-cli to npm via CI/CD pipeline"
---

# Vanguard: Publish CLI Action
...
_Vanguard Publish CLI command for unknown stack + Agent + Tools + Gateway_
