---
description: "Read file contents from the filesystem with optional offset and limit for large files."
---

# Vanguard: Read File Action
...
_Vanguard Read File command for unknown stack + Domain-Driven Design_
