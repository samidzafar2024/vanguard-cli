---
description: "Submit quiz answers for server-side scoring"
---

# Vanguard: Submit Quiz Action
...
_Vanguard Submit Quiz command for unknown stack + Domain-Driven Design_
