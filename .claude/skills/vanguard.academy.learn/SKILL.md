...
# Vanguard: Interactive Lesson Action
...
/vanguard:academy.learn [moduleId|lessonId]
...
_Vanguard Interactive Lesson command for unknown stack + MVC with Interactors_
