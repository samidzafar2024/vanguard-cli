...
# WayPoint: commit-and-push Action
...
1. **Update the manifest** at `waypoint.manifest.yaml`:
...
_WayPoint commit-and-push command for unknown stack + MVC with Interactors_