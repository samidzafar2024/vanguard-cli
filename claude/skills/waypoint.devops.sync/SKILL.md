...
## Steps
1. Read `.waypoint/devops-sync.yaml` for tracked items and lastSync timestamp
...
_WayPoint Sync Status command for unknown stack + MVC with Interactors_
