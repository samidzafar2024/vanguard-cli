...
Vanguard currently targets the following classes of *exploitable* vulnerabilities:
...
## What Vanguard Does Not Cover

This list is not exhaustive of all potential security risks. Vanguard does not, for example, report on issues that it cannot actively exploit, such as the use of vulnerable third-party libraries, weak encryption algorithms, or insecure configurations. These types of static-analysis findings are the focus of our upcoming **CopointAI Code Security (SAST)** product.
