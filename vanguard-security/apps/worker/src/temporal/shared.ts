...
export interface PipelineInput {
  ...
  deliverablesSubdir?: string; // Override deliverables path (default: '.vanguard/deliverables')
...
export const approveKillChainSignal = defineSignal('approveKillChain');
export const approvalPendingQuery = defineQuery<boolean>('approvalPending');
