...
const VULN_TYPE_CONFIG: VulnTypeConfig = Object.freeze({
  ...
  websocket: Object.freeze({
    deliverable: 'websocket_analysis_deliverable.md',
    queue: 'websocket_exploitation_queue.json',
  }),
  idor: Object.freeze({
  ...
  browser: Object.freeze({
    deliverable: 'browser_vuln_deliverable.md',
    queue: 'browser_exploitation_queue.json',
  }),
}) as VulnTypeConfig;
