...
export interface ContainerConfig {
  /** Subdirectory for deliverables relative to repoPath. Default: '.vanguard/deliverables' */
  ...
  /** Engagement mode — used by ModeDispatcher to gate agent execution. Default: 'validated' */
  readonly engagementMode?: import('./engagement.js').EngagementMode;
  /** Evidence budget in MB — used by BlastRadiusTracker. Default: 10 */
  readonly evidenceBudgetMb?: number;
}
