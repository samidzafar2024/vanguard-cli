---
description: Review code changes for Vanguard-specific patterns, security, and common mistakes
---

Review the current changes (staged or working directory) with focus on Vanguard-specific patterns and common mistakes.
...
## Step 2: Check Vanguard-Specific Patterns
